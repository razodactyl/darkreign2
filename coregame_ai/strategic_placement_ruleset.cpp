...
namespace Strategic
{
    ...
    namespace Rules
    {
        ...
        public:
            ...
            // Adjust the origin
            void AdjustOrigin(const Point<F32>& initial, Point<F32>& origin, F32 orientation) override
            {
            ...
            F32 Evaluate(const Placement::RuleSet::Info& info) override
            {
        ...
        public:
            ...
            Location(FScope* fScope)
                : Rule(fScope),
                  location(Strategic::Location::Create(fScope->GetFunction("Location"), nullptr))
            {
            }
