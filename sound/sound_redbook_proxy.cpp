...
//                 {
//                     if ((driver = AIL_redbook_open_drive(static_cast<char>(drive + 'A'))) != nullptr)
//                     {
...
//                     {
//                         if ((driver = AIL_redbook_open(i)) != nullptr)
//                         {
...
//                             {
//                                 // Get track info
//                                 AIL_redbook_track_info(driver, track, nullptr, &end);
//
...
//                 (
//                     driver, Clamp<S32>(MIN_VOLUME, static_cast<S32>((volume * static_cast<F32>(MAX_VOLUME)) + 0.5F), MAX_VOLUME)
//                 );
//             }
//         }
//
