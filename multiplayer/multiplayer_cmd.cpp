        ...
        void Handler(U32 patchCrc)
        {
            switch (patchCrc)
            {
                ...
                case 0x58706D32: // "multiplayer.login"
                {
                    if (CmdLine::host || CmdLine::join)
                    {
                        ...
                        else
                        {
                            ...
                            User::ExistingUser* user = const_cast<NBinTree<User::ExistingUser>&>(
                                User::GetExistingUsers()).GetFirst();
                            if (!user || !Login(user))
                            {
                ...
                case 0x40AC48A9: // "multiplayer.checkfirewall"
                {
                    ...
                    {
                        IControl* ctrl = IFace::Find<IControl>(name, nullptr, TRUE);

                        // Test firewall status
                        switch (Settings::GetFirewallStatus())
                        {
                            case Settings::FirewallStatus::BehindFirewall:
                                SendEvent(ctrl, nullptr, IFace::NOTIFY, 0x4F48F16E); // "Firewall::Behind"
                                break;

                            case Settings::FirewallStatus::NotBehindFirewall:
                                SendEvent(ctrl, nullptr, IFace::NOTIFY, 0x8F9D855A); // "Firewall::None"
                                break;

                            case Settings::FirewallStatus::Unknown:
                                SendEvent(ctrl, nullptr, IFace::NOTIFY, 0x3B3C35E3); // "Firewall::Unknown"
                                break;
                ...
                {
                    if (!updatingLock && Network::client && isHost)
                    {
                        if (isLocked)
                        {
                ...
                case 0x070CE316: // "multiplayer.register.client"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::clientCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x2AE622A7: // "multiplayer.register.server"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::serverCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x8878C9A3: // "multiplayer.register.setup"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::gameSetupCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0xEB9599CF: // "multiplayer.register.transfer"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::transferCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x687C14B6: // "multiplayer.register.transferlist"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::transferListCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0xA3B7A232: // "multiplayer.register.players"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::playersCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x753DC3B5: // "multiplayer.register.chat"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::chatCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x8A1633FE: // "multiplayer.register.updates"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::updateCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x47AEB6FD: // "multiplayer.register.download"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::downloadCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x648BF61F: // "multiplayer.register.info"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        PrivData::infoCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x03F9FFF5: // "multiplayer.session.joindownload"
                {
                    ...
                    if (Console::GetArgString(1, ctrl))
                    {
                        ...
                        Controls::Sessions* sessions = IFace::Find<Controls::Sessions>(ctrl, nullptr, TRUE);
                ...
                case 0x3C76198F: // "multiplayer.setup.launch"
                    Data::Send(Commands::LaunchReady, 0, nullptr, TRUE);
                    if (isHost)
                    {
                        Data::Send(Commands::Launch, 0, nullptr, TRUE);
                    }
                    break;
                ...
                case 0xBE14F836: // "multiplayer.setup.suggestmission"
                {
                    ...
                    {
                        Game::MissionSelection* missions = IFace::Find<Game::MissionSelection>(control, nullptr, TRUE);
                ...
                case 0x40D898A9: // "multiplayer.setup.setmission"
                    if (isHost)
                    {
                        ...
                        if (Console::GetArgString(1, control))
                        {
                            ...
                            if (m)
                            {
                                Host::ChangeMission(m);
                            }

                            Host::SendUpdatedSettings
                            (
                ...
                case 0xE8837E00: // "multiplayer.setup.setrandommission"
                    if (isHost)
                    {
                        ...
                        if (Console::GetArgString(1, folder))
                        {
                            ...
                            if (PrivData::preview)
                            {
                                Host::SendUpdatedRuleSet(PrivData::preview->GetRuleSet().crc);
                            }
                        }
                    }
                    break;
                ...
                {
                    if (Data::Online() && Network::HaveCurrentPlayer())
                    {
