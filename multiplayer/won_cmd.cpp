        ...
        void Handler(U32 patchCrc)
        {
            switch (patchCrc)
            {
                case 0xB353C7D6: // "won.register.connect"
                {
                    ...
                    {
                        wonConnectCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x24336AB1: // "won.register.players"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        wonPlayersCtrl = IFace::Find<ICListBox>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x3BF301F0: // "won.register.games"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        wonGamesCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x714D1A77: // "won.register.chat"
                {
                    ...
                    if (Console::GetArgString(1, name))
                    {
                        wonChatCtrl = IFace::Find<IControl>(name, nullptr, TRUE);
                    }
                    break;
                }
                ...
                case 0x1E5E8E38: // "won.rebuildrooms"
                {
                    ...
                    {
                        Controls::RoomList* roomList = IFace::Find<Controls::RoomList>(control, nullptr, TRUE);
                ...
                case 0x448982B0: // "won.rebuildgames"
                {
                    ...
                    if (Console::GetArgString(1, control))
                    {
                        Controls::GameList* gameList = IFace::Find<Controls::GameList>(control, nullptr, TRUE);
                ...
                case 0xA47E5DD1: // "won.rebuildplayers"
                {
                    ...
                    if (Console::GetArgString(1, control))
                    {
                        Controls::PlayerList* playerList = IFace::Find<Controls::PlayerList>(control, nullptr, TRUE);
                        ...
                        for (NList<WonIface::Player>::Iterator p(&players); *p; ++p)
                        {
                            ...
                            IControl* newCtrl = new Controls::PlayerList::Item(
                                *playerList, (*p)->moderator, (*p)->muted, (*p)->ignored);
                ...
                case 0x9164D365: // "won.createroom"
                {
                        ...
                        Console::GetArgString(2, password))
                    {
                        ...
                        if (Utils::Strlen(name) < 3)
                        {
                            ...
                            {
                                SendEvent(wonConnectCtrl, nullptr, IFace::NOTIFY, 0xE7F0BC86);
                                // "Error::CreateRoomNameTooShort"
                            }
                        }
                        else
                        {
                    ...
                    if (Console::GetArgString(1, control))
                    {
                        ...
                        if (room)
                        {
                            ...
                            if (room->password)
                            {
                                ...
                                if (wonConnectCtrl.Alive())
                                {
                                    SendEvent(wonConnectCtrl, nullptr, IFace::NOTIFY, 0x259B0041);
                                    // "JoinRoom::PasswordRequired"
                                }
                            }
                            else
                            {
                ...
                case 0x68FDCBFA: // "won.joingame"
                {
                    ...
                    if (Console::GetArgString(1, control))
                    {
                        ...
                        {
                            LOG_DIAG(
                                ("Joining game %s on machine %s:%d", game->GetSession().name.str, game->GetSession().
                                    address.GetText(), game->GetSession().address.GetPort()))
                            ...
                            MultiPlayer::Cmd::joinInfo = new MultiPlayer::Cmd::JoinInformation(
                                game->GetSession().address, game->GetSession().name, game->GetSession().flags);
                        }
                    }
                    else
                    {
                ...
                case 0x7B0B35F9: // "won.ignore"
                {
                    ...
                    if (Console::GetArgString(1, control))
                    {
                        ICListBox* playerList = IFace::Find<ICListBox>(control, nullptr, TRUE);
                        ...
                        if (ctrl)
                        {
                            ...
                            CONSOLE(0x4ECF28BA, ("Now ignoring '%s'", Utils::Unicode2Ansi(ctrl->GetTextString())))
                                // "WonChatLocal"
                        }
                    }
                    else
                ...
                case 0xE97B9899: // "won.checkkey"
                {
                    ...
                    {
                        IControl* ctrl = IFace::Find<IControl>(control, nullptr, TRUE);
                        ...
                        if (WonIface::CheckKey(key))
                        {
                            ...
                            SendEvent(ctrl, nullptr, IFace::NOTIFY, 0xD037F5EE); // "Won::KeySuccess"
                        }
                        else
                        {
                            SendEvent(ctrl, nullptr, IFace::NOTIFY, 0x35F01904); // "Won::KeyFailure"
                        }
                    }
                    else
                    {
