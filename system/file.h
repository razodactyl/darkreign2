...
public:
    ...
    void* MapMemory(const char* name, U32 flags = MAP_READ, U32 offset = 0, U32 length = 0, void** alignedPointer = nullptr);
...
public:
    ...
    // Current Directory
    static Bool GetCurrent(int drive, FileDir& dir);
