...
public:
    ...
    struct VarItem
    {
        ...
        void InitBinary(U32 size, const U8* val = nullptr);
        ...
        const U8* Binary();
        U32 BinarySize();
        void SetBinary(U32 size, const U8* newVal = nullptr);
    ...
    static VarItem* CreateVarItem(const char* path, void* context = nullptr);
...
public:
    ...
    static const char* BuildVarName(const char* path, void* context = nullptr);

    // Find a var using substitution, or NULL if not found
    static VarItem* FindVarItem(const char* path, void* context = nullptr, Bool required = FALSE);

    // Find a var using a path and an identifier
    static VarItem* FindVarItem(const char* path, const char* ident, void* context = nullptr);
    ...
    static VarItem* CreateVar(const char* path, const char* ident, void* context = nullptr);
    ...
    static VarItem* CreateString(const char* path, const char* value, U32 flagsIn = DEFAULT, VarString* var = nullptr, void* context = nullptr);

    // Create an INTEGER variable
    static VarItem* CreateInteger(const char* path, S32 value, U32 flagsIn = DEFAULT, VarInteger* var = nullptr, void* context = nullptr);

    // Create a FPOINT variable
    static VarItem* CreateFloat(const char* path, F32 value, U32 flagsIn = DEFAULT, VarFloat* var = nullptr, void* context = nullptr);

    // Create a BINARY variable
    static VarItem* CreateBinary(const char* path, U32 size, const U8* value = nullptr, U32 flagsIn = DEFAULT, VarBinary* var = nullptr, void* context = nullptr);

    // Create a CMD item
    static void CreateCmd(const char* path, U32 flagsIn = DEFAULT, void* context = nullptr);

    // Delete an item
    static void DeleteItem(VarItem* item);

    // Delete an item, returning FALSE if item was not found
    static Bool DeleteItem(const char* path, void* context = nullptr);
...
public:
    ...
    // Constructor
    VarString(const char* path, void* context = nullptr);

    // Constructor
    VarString(VarSys::VarItem* var);

    // Setup/change to point to the var 'path', which MUST exist
    void PointAt(const char* path, void* context = nullptr);
...
public:
    ...
    // Constructor
    VarInteger(const char* path, void* context = nullptr);
...
public:
    ...
    // Constructor
    VarFloat(const char* path, void* context = nullptr);
...
public:
    ...
    // Constructor
    VarBinary(const char* path, void* context = nullptr);
...
public:
    ...
    // Constructor
    VarCmd(const char* path, void* context = nullptr);
