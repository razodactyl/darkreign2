...
namespace RelationalOperatorTest
{
    // Greater Operator
    template <class TYPE>
    Bool Greater(TYPE value1, TYPE value2)
    {
    ...
    template <class TYPE>
    Bool GreaterEqual(TYPE value1, TYPE value2)
    {
        return (value1 >= value2);
    }
    ...
    // Less Operator
    template <class TYPE>
    Bool Less(TYPE value1, TYPE value2)
    {
        return (value1 < value2);
    }
    ...
    template <class TYPE>
    Bool LessEqual(TYPE value1, TYPE value2)
    {
        return (value1 <= value2);
    }
    ...
    // Equal Operator
    template <class TYPE>
    Bool Equal(TYPE value1, TYPE value2)
    {
        return (value1 == value2);
    }
    ...
    // Not Equal Operator
    template <class TYPE>
    Bool NotEqual(TYPE value1, TYPE value2)
    {
        return (value1 != value2);
    }
    ...
    template <>
    Bool Greater(const char* value1, const char* value2);
    template <>
    Bool GreaterEqual(const char* value1, const char* value2);
    template <>
    Bool Less(const char* value1, const char* value2);
    template <>
    Bool LessEqual(const char* value1, const char* value2);
    template <>
    Bool Equal(const char* value1, const char* value2);
    template <>
    Bool NotEqual(const char* value1, const char* value2);
};
