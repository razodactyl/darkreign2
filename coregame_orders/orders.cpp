...
namespace Orders
{
    ...
    public:
        ...
        static void Generate(Player& player)
        {
            ...
            Add(data, sizeof(Data) - (sizeof(U32) * MAX_DATA - data.length));
        }
    ...
    void Dispatch()
    {
        ...
        if (used)
        {
            ...
            else
            {
                ...
                Execute
                (
                    (U8*)el, used + sizeof(Element::Header),
                    Player::GetCurrentPlayer() ? Player::GetCurrentPlayer()->GetNameCrc() : 0x67CDF03E // "Local"
                );
            }
