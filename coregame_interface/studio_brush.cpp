...
namespace Studio
{
    ...
    namespace Brush
    {
        ...
        void Base::MouseNotify(const char* event, ::Event* e)
        {
            ...
            char buf[256];
            char* mouseName = nullptr;

            switch (button)
            {
                case MOUSE_LEFT: mouseName = "Left";
                    break;
                case MOUSE_MIDDLE: mouseName = "Middle";
                    break;
                case MOUSE_RIGHT: mouseName = "Right";
                    break;
            }
        ...
        void Base::RestoreMousePosition()
        {
            ...
            data.cInfo.mObject.mapObj = nullptr;
            data.cInfo.mTerrain.cell = nullptr;
        }
        ...
        // Constructor
        //
        BrushConfig::BrushConfig(IControl* parent) : ICWindow(parent), brush(nullptr)
        {
        }
        ...
        Base* Get(const char* name)
        {
            ...
            Base* brush = name ? brushes.Find(Crc::CalcStr(name)) : nullptr;
