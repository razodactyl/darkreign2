...
namespace Studio
{
                                ...
                                for (NList<IControl>::Iterator c(&filteringTypeList->GetItems()); *c; ++c)
                                {
                                    ...
                                    if (type->HasProperty(e.iface.p2))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if ((*c)->GetControlState() & STATE_SELECTED)
                                            {
    ...
    void TeamEditor::Upload()
    {
        ...
        {
            objectivesList->AddTextItem((*o)->GetName(), nullptr);
        }
    ...
    {
        UnitObjTypeList* types = static_cast<UnitObjTypeList*>(context);
