...
namespace Client
{
    namespace Events
    {
        ...
        static void RandomResponse(UnitObj* obj, U32 event)
        {
            ...
            {
                Submit("Response", response, Sound::Digital::Reserved::MODE4);
            }
        }
        ...
        {
            return (obj ? Promote::Object<UnitObjType, UnitObj>(obj) : nullptr);
        }
        ...
        void UnitsSelected()
        {
            ...
            UnitObj* single = (data.sList.GetCount() == 1) ? data.sList.GetFirst() : nullptr;
        ...
        static Bool StepUnitSelection(Bool next, Bool filterType, U32 property = 0)
        {
            ...
            UnitObjType* type = unit ? unit->UnitType() : nullptr;
        ...
        static void SetupPrimaryEvent()
        {
            ...
            if (e == PE_NONE && i.o.map.Alive())
            {
                ...
                if ((e != PE_SELECT) || !Common::Input::GetModifierKey(3))
                {
                    ...
                    RestoreObj* restoreStatic = nullptr;
        ...
        static void SetupCommonCycle()
        {
            ...
            if (data.cInfo.gameWnd.Alive())
            {
                ...
                Common::Cycle::SetMouseOverObject(data.cInfo.o.map.Alive() ? data.cInfo.o.map.GetData() : nullptr);
            }
        ...
        static void SetupCycleInfo()
        {
            ...
            i.oneUnit = (data.sList.GetCount() == 1) ? IsUnit(data.sList.GetFirst()) : nullptr;
            ...
            if (data.processing && i.gameWnd.Alive() && !data.captureHandler)
            {
                ...
                else
                {
                    ...
                    // Promote to a unit
                    i.o.unit = i.o.map.Alive() ? IsUnit(i.o.map) : nullptr;
...
#pragma message("Client disabled")
        ...
        void Init()
        {
            ...
            data.cInfo.oneUnit = nullptr;
            data.cInfo.gameWnd = nullptr;
            ...
            data.squad = nullptr;
            data.constructType = nullptr;
            data.hiliteConstructType = nullptr;
            data.dir = WorldCtrl::SOUTH;

            data.formation = 0;

            // Interface controls
            data.controls.construction = nullptr;
            data.controls.context = nullptr;
            data.controls.orders = nullptr;
            data.controls.facility = nullptr;
            data.controls.trails = nullptr;
