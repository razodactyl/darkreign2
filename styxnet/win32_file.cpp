...
namespace Win32
{
    ...
    Bool File::Open(const char* path, U32 modeIn)
    {
        ...
        handle = CreateFile(path, access, share, nullptr, create, attrib, nullptr);
    ...
    U32 File::Read(void* buffer, U32 count, U32 size)
    {
        ...
        if (ReadFile(handle, buffer, total, &read, nullptr))
        {
            return (read);
        }
    ...
    U32 File::Write(const void* src, U32 count, U32 size)
    {
        ...
        if (!WriteFile(handle, src, total, &written, nullptr))
        {
            return (written);
        }
    ...
    U32 File::Tell()
    {
        ...
        U32 offset = SetFilePointer(handle, 0, nullptr, FILE_CURRENT);
    ...
    {
        ASSERT(IsOpen());
        U32 size = GetFileSize(handle, nullptr);
        return (size);
    }
    ...
    Bool File::Mapping::Setup(File& file, U32 offset, U32 length)
    {
        ...
        U32 size = GetFileSize(file.handle, nullptr);
        ...
        handle = CreateFileMapping(file.handle, nullptr, f, 0, size, nullptr);
        ...
        ptr = static_cast<U8*>(MapViewOfFile(handle, f, 0, offset, length));
    ...
    namespace Dir
    {
        ...
        {
            _makepath(path.str, nullptr, dir, fname, nullptr);
            return (TRUE);
        }
    }
}
