...
namespace Resolver
{
    ...
    //
    template <class OBJECT, class TYPE, class NODE>
    void ObjList(ReaperList<OBJECT, NODE>& list)
    {
    ...
    //
    template <class TYPE>
    void Type(Reaper<TYPE>& ptr, const GameIdent& ident, Bool required = FALSE)
    {
        // Find the type
    ...
    //
    template <class TYPE>
    void Type(Reaper<TYPE>& ptr, Bool required = FALSE)
    {
        // Does 'ptr' need to be resolved
        if (ptr.HasResolveId())
        {
    ...
    void TypeList(ReaperList<TYPE, NODE>& list)
    {
