...
namespace FootPrint
{
    ...
    public:
        ...
        struct Cell
        {
            ...
            {
                flags = static_cast<U8>((value) ? (flags | f) : (flags & ~f));
            }
        };
    ...
    public:
        ...
        Placement();
        Placement(Type* type, Team* team = nullptr);
        ~Placement();

        // Setup with a footprint type
        void Init(Type* type, Team* team = nullptr);
    ...
    F32 FindFloor(F32 x, F32 z, S32 cx, S32 cz, Vector* surfNormal = nullptr);
