...
#define PS_PERCYCLE 10000 // 1000 -> 10000 (Processing too few cells per cycle causes units to lock up when there are enough units)
...
#define SuccessorAdvance(s, suc, v) \
    ...
    // JONATHAN - Seems to be related to flying units.
    //
