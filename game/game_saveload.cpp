                ...
                case IFace::NOTIFY:
                {
                    ...
                    switch (e.iface.p1)
                    {
                        case SaveLoadMsg::Select:
                        {
                            IFace::PostEvent
                            (
                                this, NULL, IFace::NOTIFY, SaveGame::SlotUsed(slotName->GetStringValue()) ? SaveLoadNotify::SelectedUsed : SaveLoadNotify::SelectedFree
                            );
                            return (TRUE);
                        }
                        ...
                        case SaveLoadMsg::SaveRequest:
                        {
                            if (const Missions::Mission* mission = Missions::GetActive())
                            {
                                ...
                                IFace::PostEvent
                                (
                                    this, NULL, IFace::NOTIFY, SaveGame::SlotUsed(slotName->GetStringValue()) ? SaveLoadNotify::SaveSlotUsed : SaveLoadNotify::SaveSlotFree
                                );
                            }
                            return (TRUE);
                        }
