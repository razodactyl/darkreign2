...
namespace User
{
    ...
    static const char* GetUserPath(const FileIdent& name)
    {
        ...
        // Generate the path
        Utils::MakePath(path.str, path.GetSize(), USER_PATH, buf, nullptr);
    ...
    static const char* GetFile(const char* path, const char* file)
    {
        ...
        // Generate the path
        Utils::MakePath(full.str, full.GetSize(), path, file, nullptr);
    ...
    static ExistingUser* RegisterNewUserFromDir(const char* dir)
    {
        ...
        Utils::MakePath(path.str, path.GetSize(), USER_PATH, dir, nullptr);
